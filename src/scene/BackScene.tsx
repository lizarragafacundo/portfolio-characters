...
export interface BackSceneProps {
  viewBox: string
  objects: Record<SceneObjectId, boolean>
}

export const BackScene = forwardRef<SVGSVGElement, BackSceneProps>(function BackScene(
  { viewBox, objects },
  ref,
) {
  return (
    ...
    >
      ...
      <DeskObjectLayer scene="back" enabled={objects} />
    </svg>
  )
})
