...
export const BackScene = forwardRef<SVGSVGElement, { viewBox: string }>(function BackScene(
  ...
  return (
    ...
    >
      ...
      <g>
        ...
        <g stroke="var(--dc-ink)" fill="none" strokeLinecap="round">
          <rect
            ...
            strokeWidth="3"
            pathLength={1}
            style={draw(0.55, 0.08, EASE_DRAW)}
          />
          <path
      ...
      <g>
        <g data-fillel="" style={fill(0.4, 0.6)}>
      ...
      <g>
        <g data-fillel="" style={fill(0.45, 0.7)}>
        ...
        <g stroke="var(--dc-ink)" fill="none" strokeLinecap="round" strokeLinejoin="round">
          ...
          <g strokeWidth="2.2">
            <path d="M816,222 L814,206 L842,206 L840,222" pathLength={1} style={draw(0.4, 0.66)} />
            <path
