...
import { DeskObjectLayer } from './DeskObjectLayer'
import type { SceneObjectId } from './deskObjectPlacement'
        ...
        {objects.plant ? (
          <g>
            <g
              data-amb=""
              style={{
                transformOrigin: '157px 438px',
                animation: 'chsway 7s ease-in-out infinite',
              }}
            >
              <path
        ...
        {objects.coffee ? (
          <g>
            ...
            <ellipse
              ...
              stroke="none"
              data-fillel=""
              style={fadeIn(0.4, 0.62)}
            />
            <path
              d="M279,450 C298,449 302,472 283,475"
              strokeWidth="2.8"
              pathLength={1}
              style={drawStroke(0.4, 0.38)}
            />
            <path
        ...
        {objects.laptop ? (
          <g transform={laptop.group}>
            <rect
              ...
              strokeWidth="3.6"
              pathLength={1}
              style={drawStroke(0.55, 0.18, EASE_DRAW)}
            />
            <path
              ...
              strokeWidth="2"
              pathLength={1}
              style={drawStroke(0.5, 0.12, EASE_DRAW)}
            />
          </g>
        ) : null}

        <DeskObjectLayer scene="front" enabled={objects} />

        <path
          d="M40,482 C280,474 620,490 862,480"
          strokeWidth="3.6"
          pathLength={1}
          style={drawStroke(0.6, 0, EASE_DRAW)}
        />
        <path
